...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000001, 0x3551d90b, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000000, 0x00000000, 0x00000E7F, do_dump_all},
		{0x00000000, 0x00000000, 0x00000000, do_lens_id}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT sc820cs_mtk_eeprom = {
	.name = "sc820cs_mtk_eeprom",
